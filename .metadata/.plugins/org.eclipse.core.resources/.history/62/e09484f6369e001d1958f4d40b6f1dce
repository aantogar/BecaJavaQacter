...
public class ErrorMessages {
	 ...
	 */
	public static final String PROERR_007="La fecha no puede ser inferior que la indicada";
	public static final String PROERR_008="La fecha no puede ser superior que la indicada";
